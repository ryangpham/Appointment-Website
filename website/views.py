...
class AppointmentTemplateView(TemplateView):
    ...
    def post(self, request):
        ...
        messages.add_message(request, messages.SUCCESS, f"Thank you, {fname}, for making an appointment with us. We will send you an e-mail of your appointment.")
...
class ManageAppointmentTemplateView(ListView):
    ...
    def post(self, request):
        ...
        messages.add_message(request, messages.SUCCESS, f"You accepted {appointment.first_name}'s appointment.")
        return HttpResponseRedirect(request.path)
